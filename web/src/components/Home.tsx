 ...
 * where "find out more" leads. Commercial terms live on /home/license.
 *
...
const PILLARS = [
  {
    ...
    points: [
      ...
      'Equal-power crossfader with slam buttons and timed auto-fades',
    ],
  },
  {
  ...
  {
    title: 'Wire it into the rest of the show',
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'That is the only way it runs. See the licensing page for what that involves, and the setup guide for how long it takes.',
  },
];
      ...
      <div className="lic-inner">
        <header className="lic-hero">
          ...
          <div className="lic-cta">
            <a className="btn primary lic-btn" href="/home/license">
              Licence it for your server
            </a>
            <a className="btn lic-btn lic-btn-ghost" href="/">
              Sign in
            </a>
          </div>
        ...
        <section className="lic-close">
          ...
          <span className="lic-close-mail">
            or read the <a href="/home/setup">setup guide</a> first
          </span>
        </section>
